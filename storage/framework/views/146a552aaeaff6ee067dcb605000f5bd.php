                ...
                <tr class="hover:bg-red-50/30 transition-colors group">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex flex-col">
                            <span class="text-sm font-bold text-stone-800"><?php echo e($order->user->name ?? 'Guest'); ?></span>
                            <span class="text-[10px] text-stone-400 font-medium"><?php echo e($order->items->count()); ?> Menu Dipesan</span>
                        </div>
                    </td>
                    ...
                    <td class="px-6 py-4">
                        ...
                        ?>
                        <span class="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter <?php echo e($statusClasses[$order->status] ?? 'bg-gray-100'); ?>">
                            <?php echo e($order->status); ?>

                        </span>
                    </td>
                    <td class="px-6 py-4 text-xs text-stone-500 font-medium"><?php echo e($order->created_at->format('d M Y')); ?></td>
        ...
        <div class="relative bg-white rounded-[2.5rem] w-full max-w-2xl shadow-2xl overflow-hidden animate-zoom-in">
            ...
            <div class="bg-red-800 p-8 text-white flex justify-between items-center">
                <div>
                    ...
                    <p class="text-[10px] uppercase tracking-[0.3em] opacity-70">ID Pesanan: #<?php echo e($selectedOrder->order_number); ?></p>
                </div>
            ...
            <div class="p-8 max-h-[70vh] overflow-y-auto custom-scrollbar">
                ...
                <div class="grid grid-cols-2 gap-6 mb-8 pb-6 border-b border-stone-100">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-sm font-bold text-red-700 uppercase tracking-tighter"><?php echo e(ucfirst($selectedOrder->order_type)); ?></p>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-stone-50">
                            ...
                            <tr>
                                <td class="py-4 text-sm font-serif font-bold text-stone-800"><?php echo e($item->menu_name); ?></td>
                                <td class="py-4 text-center font-mono text-xs"><?php echo e($item->quantity); ?></td>
                                <td class="py-4 text-right font-bold text-stone-800 text-sm">Rp<?php echo e(number_format($item->subtotal, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </tbody>
                    </table>
                ...
                <div class="bg-stone-50 rounded-2xl p-6 space-y-3">
                    ...
                    <div class="flex justify-between font-black text-lg text-stone-900 border-t border-stone-200 pt-3 mt-3 tracking-tighter italic">
                        ...
                        <span class="text-red-700 italic">Rp<?php echo e(number_format($selectedOrder->total, 0, ',', '.')); ?></span>
                    </div>
                </div>
...
</div><?php /**PATH D:\projek 12\china-app\resources\views\livewire\Admin\order-management.blade.php ENDPATH**/ ?>