        ...
        <div class="flex justify-between items-center h-20">
            ...
            <div class="flex items-center gap-8">
                <a href="/" class="flex items-center gap-3 group">
                    ...
                    <div class="w-10 h-10 rounded-xl overflow-hidden shadow-indigo-200 shadow-md bg-indigo-50 flex items-center justify-center transition-transform group-hover:scale-105">
                        <?php $dbLogo = \App\Models\SystemConfig::value('brand_logo'); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dbLogo): ?>
                            <img src="https://bbbvjqzpktarmsblmblv.supabase.co/storage/v1/object/public/chinaon/<?php echo e($dbLogo); ?>" class="w-full h-full object-cover">
                        <?php else: ?>
                    ...
                    <span class="text-2xl font-brand tracking-wide bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-cyan-500">
                        <?php echo e(\App\Models\SystemConfig::value('brand_name') ?? 'UKITA'); ?>
                ...
                <div class="hidden lg:flex items-center gap-1">
                    <a href="<?php echo e(route('home')); ?>" 
                       class="px-4 py-2 rounded-full text-sm font-bold transition-all <?php echo e(request()->routeIs('home') ? 'bg-indigo-50 text-indigo-600' : 'text-slate-600 hover:text-indigo-600 hover:bg-slate-50'); ?>">
                        <?php echo e(__('language.home')); ?>

                    </a>
                    <a href="<?php echo e(route('menu')); ?>" 
                       class="px-4 py-2 rounded-full text-sm font-bold transition-all <?php echo e(request()->routeIs('menu') ? 'bg-indigo-50 text-indigo-600' : 'text-slate-600 hover:text-indigo-600 hover:bg-slate-50'); ?>">
                        <?php echo e(__('language.menu')); ?>

                    </a>
                    <a href="<?php echo e(route('orders')); ?>" 
                       class="px-4 py-2 rounded-full text-sm font-bold transition-all <?php echo e(request()->routeIs('orders') ? 'bg-indigo-50 text-indigo-600' : 'text-slate-600 hover:text-indigo-600 hover:bg-slate-50'); ?>">
                        <?php echo e(__('language.orders')); ?>

                    </a>
                    <a href="<?php echo e(route('reservation')); ?>" 
                       class="px-4 py-2 rounded-full text-sm font-bold transition-all <?php echo e(request()->routeIs('reservation') ? 'bg-indigo-50 text-indigo-600' : 'text-slate-600 hover:text-indigo-600 hover:bg-slate-50'); ?>">
                        <?php echo e(__('language.reservations')); ?>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="hidden md:flex items-center bg-slate-100/50 border border-slate-200 rounded-full p-1">
                    <button wire:click="setLanguage('en')" class="px-3 py-1 rounded-full text-xs font-bold transition-all <?php echo e(app()->getLocale() === 'en' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-indigo-600'); ?>">EN</button>
                    <button wire:click="setLanguage('cn')" class="px-3 py-1 rounded-full text-xs font-bold transition-all <?php echo e(app()->getLocale() === 'cn' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-indigo-600'); ?>">CN</button>
                </div>
...
?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                    <div class="hidden md:flex items-center gap-3">
                        ...
                        <button wire:click="openRegisterModal" class="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-600/20 transition-all transform hover:scale-105">
                            <?php echo e(__('language.register')); ?>
                ...
                <?php else: ?>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <a href="<?php echo e(route('user.settings')); ?>" class="flex items-center gap-3 px-4 py-2 text-sm text-slate-600 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
    ...
    <div x-show="mobileMenuOpen" x-cloak 
        ...
        <div class="px-6 py-6 space-y-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('home')); ?>" class="block px-4 py-3 rounded-xl font-bold <?php echo e(request()->routeIs('home') ? 'bg-indigo-50 text-indigo-600' : 'text-slate-600 hover:bg-slate-50'); ?>">
                    <?php echo e(__('language.home')); ?>

                </a>
                <a href="<?php echo e(route('menu')); ?>" class="block px-4 py-3 rounded-xl font-bold <?php echo e(request()->routeIs('menu') ? 'bg-indigo-50 text-indigo-600' : 'text-slate-600 hover:bg-slate-50'); ?>">
                    <?php echo e(__('language.menu')); ?>

                </a>
                <a href="<?php echo e(route('orders')); ?>" class="block px-4 py-3 rounded-xl font-bold <?php echo e(request()->routeIs('orders') ? 'bg-indigo-50 text-indigo-600' : 'text-slate-600 hover:bg-slate-50'); ?>">
                    <?php echo e(__('language.orders')); ?>

                </a>
                <a href="<?php echo e(route('reservation')); ?>" class="block px-4 py-3 rounded-xl font-bold <?php echo e(request()->routeIs('reservation') ? 'bg-indigo-50 text-indigo-600' : 'text-slate-600 hover:bg-slate-50'); ?>">
                    <?php echo e(__('language.reservations')); ?>
            ...
            <div class="flex items-center justify-between px-4">
                ...
                <div class="flex gap-2">
                    <button wire:click="setLanguage('en')" class="px-3 py-1 rounded-lg text-xs font-bold <?php echo e(app()->getLocale() === 'en' ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-500'); ?>">EN</button>
                    <button wire:click="setLanguage('cn')" class="px-3 py-1 rounded-lg text-xs font-bold <?php echo e(app()->getLocale() === 'cn' ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-500'); ?>">CN</button>
                </div>
            </div>
...
</nav><?php /**PATH E:\12 RPL\china-app\resources\views/livewire/navbar.blade.php ENDPATH**/ ?>