<div x-data="{ open: <?php if ((object) ('showLogoutConfirm') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showLogoutConfirm'->value()); ?>')<?php echo e('showLogoutConfirm'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showLogoutConfirm'); ?>')<?php endif; ?> }">
