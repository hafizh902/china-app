            ...
            <div class="flex items-center space-x-2 md:space-x-4">
                ...
                <div class="hidden md:flex items-center gap-1 font-medium">
                    <button type="button" wire:click="setLanguage('en')" wire:loading.disable
                        class="transition-colors <?php echo e(app()->getLocale() === 'en' ? 'text-red-600 font-semibold' : 'text-gray-700 hover:text-red-600'); ?>">
                        EN
                    </button>
                    <span class="text-gray-400">|</span>
                    <button type="button" wire:click="setLanguage('cn')" wire:loading.disable
                        class="transition-colors <?php echo e(app()->getLocale() === 'cn' ? 'text-red-600 font-semibold' : 'text-gray-700 hover:text-red-600'); ?>">
                        CN
                    </button>
                </div>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3445338555-1', null);
...
?>
                ...
                <?php else: ?>
                    <div class="flex items-center space-x-2 md:space-x-3">
                        <button wire:click="openLoginModal"
                            ...
                            <i class="fas fa-sign-in-alt md:mr-2"></i><span class="hidden md:inline"><?php echo e(__('language.login')); ?></span>
                        </button>
                        <button wire:click="openRegisterModal"
                            ...
                            <i class="fas fa-user-plus md:mr-2"></i><span class="hidden md:inline"><?php echo e(__('language.register')); ?></span>
                        </button>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="px-4 py-3 space-y-1">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center px-4 py-3 text-gray-700 hover:bg-red-50 hover:text-red-600 rounded-lg transition-colors">
                <i class="fas fa-home w-8"></i> <?php echo e(__('language.home')); ?>

            </a>
            <a href="<?php echo e(route('menu')); ?>" class="flex items-center px-4 py-3 text-gray-700 hover:bg-red-50 hover:text-red-600 rounded-lg transition-colors">
                <i class="fas fa-utensils w-8"></i> <?php echo e(__('language.menu')); ?>

            </a>
            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('orders')); ?>" class="flex items-center px-4 py-3 text-gray-700 hover:bg-red-50 hover:text-red-600 rounded-lg transition-colors">
                    <i class="fas fa-shopping-bag w-8"></i> <?php echo e(__('language.orders')); ?>

                </a>
                <a href="<?php echo e(route('reservation')); ?>" class="flex items-center px-4 py-3 text-gray-700 hover:bg-red-50 hover:text-red-600 rounded-lg transition-colors">
                    <i class="fas fa-calendar-check w-8"></i> <?php echo e(__('language.reservations')); ?>
            ...
            <div class="flex items-center px-4 py-4 border-t border-gray-50 mt-2">
                ...
                <button wire:click="setLanguage('en')" class="px-3 py-1 rounded-md <?php echo e(app()->getLocale() === 'en' ? 'bg-red-600 text-white' : 'text-gray-600'); ?>">EN</button>
                <button wire:click="setLanguage('cn')" class="px-3 py-1 rounded-md <?php echo e(app()->getLocale() === 'cn' ? 'bg-red-600 text-white' : 'text-gray-600'); ?> ml-2">CN</button>
            </div>
        </div>
    </div>
</nav><?php /**PATH D:\projek 12\china-app\resources\views/livewire/navbar.blade.php ENDPATH**/ ?>