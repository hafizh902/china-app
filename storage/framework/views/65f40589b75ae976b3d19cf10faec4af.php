        ...
        <div class="p-8">
            <form method="POST" action="<?php echo e(route('password.update')); ?>" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="email" name="email" type="email" value="<?php echo e(request('email')); ?>" readonly class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-100 text-gray-500 cursor-not-allowed">
                </div>
...
<?php /**PATH E:\12 RPL\china-app\resources\views/livewire/auth/reset-password-modal.blade.php ENDPATH**/ ?>