    ...
    <div class="max-w-md w-full space-y-8 bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        >
            ...
            <div x-show="!showRecoveryInput" class="space-y-6">
                ...
                <form method="POST" action="<?php echo e(route('two-factor.login.store')); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <!-- Back to Login -->
        <div class="text-center">
            <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-500 hover:text-gray-700 transition-colors">
                <i class="fas fa-arrow-left mr-1"></i>Kembali ke Login
            </a>
        </div>
    </div>
</div>
<?php /**PATH D:\projek 12\china-app\resources\views\livewire\auth\two-factor-challenge.blade.php ENDPATH**/ ?>