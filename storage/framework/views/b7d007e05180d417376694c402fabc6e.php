    ...
    <div x-show="isOpen"
        ...
        <div class="bg-chinese-black p-4 flex items-center justify-between border-b border-chinese-gold/20">
            <div class="flex items-center gap-3">
                ...
                <div class="ml-1">
                    <h3 class="text-[10px] font-black text-chinese-gold uppercase tracking-widest leading-none">
                        Golden Dragon
                    </h3>
                    <p class="text-[14px] text-white/90 font-chinese mt-1">
                        御用助手
                        <span class="text-[8px] italic text-white/40 uppercase ml-1">
                            Imperial Concierge
                        </span>
                    </p>
                </div>
        ...
        <div id="chat-container"
            ...
            <div wire:loading wire:target="sendMessage"
                ...
                <div class="bg-white border-l-4 border-chinese-gold p-3 rounded-r-xl rounded-bl-xl shadow-sm text-stone-500 text-[11px] flex items-center gap-2">
        ...
        <div class="p-4 bg-white border-t border-stone-50">
            <form wire:submit.prevent="sendMessage" class="relative flex items-center gap-2">
                ...
                <input type="text"
                    ...
                    class="w-full bg-stone-50 border border-stone-100 rounded-full px-4 py-2.5 text-[11px] focus:ring-1 focus:ring-chinese-red/20 outline-none disabled:opacity-50">

                <button type="submit"
                    wire:loading.attr="disabled"
                    wire:target="sendMessage"
                    class="w-9 h-9 bg-chinese-black text-chinese-gold rounded-xl flex items-center justify-center hover:bg-chinese-red transition-all shadow-lg active:scale-90 disabled:opacity-50">
...
<?php /**PATH D:\laragon\www\china-app\resources\views/livewire/chat-assistant.blade.php ENDPATH**/ ?>