               ...
               <div :class="expanded ? 'max-h-32 overflow-y-auto pr-2 custom-scrollbar' : 'line-clamp-4'"
                ...
                <div class="mt-auto pt-5 border-t border-slate-100">
                    ...
                    <button
                        ...
                        wire:click="$dispatchTo('cart-component', 'add-to-cart', [<?php echo e($selectedItem['id']); ?>, <?php echo \Illuminate\Support\Js::from($selectedItem['name'])->toHtml() ?>, <?php echo e($selectedItem['price']); ?>, <?php echo \Illuminate\Support\Js::from($selectedItem['image'])->toHtml() ?>])"
