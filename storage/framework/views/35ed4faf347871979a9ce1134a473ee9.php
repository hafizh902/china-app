            ...
            <div class="w-full md:w-1/2 p-6 md:p-10 flex flex-col h-full">
                ...
                <div class="flex flex-wrap items-center gap-4 mb-6 pt-4 border-t border-slate-50">
                    ...
                    <div class="flex flex-col gap-1">
                        <p class="text-[9px] text-slate-400 uppercase tracking-widest"><?php echo e(__('language.popularity')); ?></p>
                        <div class="text-[10px] text-slate-400 font-bold uppercase tracking-tighter flex items-center gap-1">
                            <i class="fas fa-fire text-red-500"></i>
                            <?php echo e(number_format($selectedItem['total_sold'] ?? 0)); ?> orders
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-1">
                        <p class="text-[9px] text-slate-400 uppercase tracking-widest"><?php echo e(__('language.category')); ?></p>
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                ...
                                <?php echo e(__('language.freshly_made')); ?>
                ...
                <div class="mt-auto pt-4 border-t border-slate-100">
                    <div class="flex items-end justify-between mb-6">
                        <div>
                            <p class="text-[10px] text-slate-400 uppercase tracking-widest mb-1"><?php echo e(__('language.price_per_item')); ?></p>
                            <span class="text-3xl font-black text-red-700">
                                <span
                                    class="text-lg font-normal mr-1">Rp</span><?php echo e(number_format($selectedItem['price'], 0, ',', '.')); ?>
...
</div><?php /**PATH D:\laragon\www\china-app\resources\views/livewire/Pages/preview-modal.blade.php ENDPATH**/ ?>