        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-8">
                <div class="flex items-center space-x-3">
                    ...
                    <h1 class="text-2xl font-bold bg-gradient-to-r from-red-600 to-red-700 bg-clip-text text-transparent" style="font-family: 'Noto Sans SC', sans-serif;">
                        China Street Food
                    </h1>
                </div>
                ...
                <div class="hidden lg:flex space-x-1">
                    <a href="<?php echo e(route('home')); ?>" class="px-4 py-2 text-gray-700 hover:text-red-600 hover:bg-red-50 font-medium transition-all duration-200 rounded-lg <?php echo e(request()->routeIs('home') ? 'text-red-600 bg-red-50' : ''); ?>">
                        <i class="fas fa-home mr-2"></i>Home
                    </a>
                    <a href="<?php echo e(route('menu')); ?>" class="px-4 py-2 text-gray-700 hover:text-red-600 hover:bg-red-50 font-medium transition-all duration-200 rounded-lg <?php echo e(request()->routeIs('menu') ? 'text-red-600 bg-red-50' : ''); ?>">
                        <i class="fas fa-utensils mr-2"></i>Menu
                    </a>
                    <a href="<?php echo e(route('orders')); ?>" class="px-4 py-2 text-gray-700 hover:text-red-600 hover:bg-red-50 font-medium transition-all duration-200 rounded-lg <?php echo e(request()->routeIs('orders') ? 'text-red-600 bg-red-50' : ''); ?>">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->role === 'admin'): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-4 py-2 text-gray-700 hover:text-red-600 hover:bg-red-50 font-medium transition-all duration-200 rounded-lg <?php echo e(request()->routeIs('admin.*') ? 'text-red-600 bg-red-50' : ''); ?>">
...
?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        >
                            <!-- User Avatar -->
                            <div class="w-8 h-8 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center text-white font-semibold text-sm">
                            ...
                            <div class="hidden sm:block text-left">
                                ...
                                <div class="text-xs text-gray-500"><?php echo e(auth()->user()->role === 'admin' ? 'Administrator' : 'Customer'); ?></div>
                            </div>
                            <!-- Dropdown Icon -->
                        ...
                        >
                            ...
                            <!-- Menu Items -->
                            <div class="py-2">
                                <a href="<?php echo e(route('user.settings')); ?>" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-red-50 hover:text-red-600 transition-colors">
                                    <i class="fas fa-user-cog mr-3 text-gray-400"></i>
                                    <span>Pengaturan</span>
                                </a>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->role === 'admin'): ?>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-red-50 hover:text-red-600 transition-colors">
    ...
    <div class="lg:hidden border-t border-gray-100 bg-gray-50 px-4 py-3">
        <div class="flex justify-around">
            <a href="<?php echo e(route('home')); ?>" class="flex flex-col items-center text-gray-600 hover:text-red-600 transition-colors <?php echo e(request()->routeIs('home') ? 'text-red-600' : ''); ?>">
                <i class="fas fa-home text-lg mb-1"></i>
                <span class="text-xs">Home</span>
            </a>
            <a href="<?php echo e(route('menu')); ?>" class="flex flex-col items-center text-gray-600 hover:text-red-600 transition-colors <?php echo e(request()->routeIs('menu') ? 'text-red-600' : ''); ?>">
                <i class="fas fa-utensils text-lg mb-1"></i>
                <span class="text-xs">Menu</span>
            </a>
            <a href="<?php echo e(route('orders')); ?>" class="flex flex-col items-center text-gray-600 hover:text-red-600 transition-colors <?php echo e(request()->routeIs('orders') ? 'text-red-600' : ''); ?>">
                <i class="fas fa-shopping-bag text-lg mb-1"></i>
                <span class="text-xs">Orders</span>
            </a>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('user.settings')); ?>" class="flex flex-col items-center text-gray-600 hover:text-red-600 transition-colors">
...
<div id="logout-confirm-modal"
     class="fixed inset-0 z-[10000] overflow-y-auto flex items-center justify-center"
     style="display: <?php echo e($showLogoutConfirm ? 'flex' : 'none'); ?>; background-color: rgba(0, 0, 0, <?php echo e($showLogoutConfirm ? '0.5' : '0'); ?>);"
     @click.self="$wire.cancelLogout()"
     @keydown.escape="$wire.cancelLogout()">
...
</div><?php /**PATH D:\laragon\www\12PPLG\china-app\resources\views/livewire/navbar.blade.php ENDPATH**/ ?>