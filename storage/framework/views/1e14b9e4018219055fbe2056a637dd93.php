...
<div class="space-y-6 font-sans">
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
        <div class="space-y-1">
            ...
            <h2 class="text-xl font-extrabold text-gray-900 tracking-tight"><?php echo e($monthLabel); ?></h2>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($autoSelectedMonth): ?>
                <p class="text-[11px] text-amber-500 font-medium italic">
                    <i class="fas fa-info-circle mr-1"></i> Data <?php echo e($currentMonthLabel); ?> kosong. Menampilkan data terakhir.
                </p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>

        <form method="GET" action="<?php echo e(url()->current()); ?>" class="flex items-center gap-2 bg-gray-50 p-1.5 rounded-xl border border-gray-100">
            <input
                type="month"
                name="month"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div class="group relative overflow-hidden bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <div class="relative z-10">
                ...
                <p class="text-3xl font-black text-gray-900">
                    <span class="text-sm font-bold text-red-500 mr-1">Rp</span><?php echo e(number_format($totalSpent, 0, ',', '.')); ?>
        ...
        <div class="group relative overflow-hidden bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <div class="relative z-10">
                ...
                <p class="text-3xl font-black text-gray-900">
                    <?php echo e(number_format($orderCount, 0, ',', '.')); ?> <span class="text-sm font-bold text-gray-400 italic">Orders</span>
                </p>
            </div>
    ...
    <div
        ...
        x-init="initChart(<?php echo \Illuminate\Support\Js::from($dates)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($totals)->toHtml() ?>)"
    ...
    >
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasSpendingThisMonth): ?>
...
</script><?php /**PATH D:\laragon\www\china-app\resources\views/livewire/user/spending-chart.blade.php ENDPATH**/ ?>