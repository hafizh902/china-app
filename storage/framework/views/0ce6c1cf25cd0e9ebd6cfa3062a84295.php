<div class="bg-[#fdfcf8] min-h-screen pb-20">
    ...
    <div x-data="{ open: <?php if ((object) ('showModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'->value()); ?>')<?php echo e('showModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'); ?>')<?php endif; ?> }" x-show="open" style="display: none;"
                    ...
                    <div class="flex justify-between items-start border-b-2 border-stone-100 pb-8 relative z-10">
                        ...
                        <div class="text-right">
                            <h2 class="text-xl font-serif font-bold text-red-800 uppercase tracking-widest">Nota
                                Pembayaran</h2>
                            <p class="text-xs font-mono text-stone-500 mt-1">#<?php echo e($order->order_number); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-8 py-8 text-sm relative z-10">
                        ...
                        <div class="text-right">
                            <p class="text-[10px] font-black text-stone-400 uppercase tracking-[0.2em] mb-2">Waktu
                                Transaksi:</p>
                            <p class="font-bold text-stone-800"><?php echo e($order->created_at->format('d F Y')); ?></p>
                            <p class="text-stone-500 text-xs italic"><?php echo e($order->created_at->format('H:i T')); ?></p>
                        </div>
                    </div>
                            ...
                            <tbody class="text-sm text-stone-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b border-stone-100">
                                        <td class="py-4 px-2 font-serif font-bold"><?php echo e($item->menu_name); ?></td>
                                        <td class="py-4 px-2 text-center font-mono"><?php echo e($item->quantity); ?></td>
                                        <td class="py-4 px-2 text-right text-xs">
                                            Rp<?php echo e(number_format($item->menu_price, 0, ',', '.')); ?></td>
                    ...
                    <div class="mt-8 flex justify-end relative z-10">
                        <div class="w-full max-w-[250px] space-y-3">
                            ...
                            <div class="flex justify-between text-xs text-stone-500">
                                ...
                                <span>Rp<?php echo e(number_format($order->tax, 0, ',', '.')); ?></span>
                            </div>
                            <div class="pt-4 border-t-2 border-stone-800 flex justify-between items-end">
                                ...
                                <span
                                    class="text-2xl font-black text-stone-900 tracking-tighter">Rp<?php echo e(number_format($order->total, 0, ',', '.')); ?></span>
                            </div>
                        </div>
                    </div>
