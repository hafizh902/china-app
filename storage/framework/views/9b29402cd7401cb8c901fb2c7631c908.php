                    ...
                    <tbody class="text-gray-600">
                        ...
                        <tr class="border-b last:border-0 hover:bg-gray-50 transition">
                            ...
                            <td class="py-4 px-4 text-sm">
                                ...
                                <?php if($order[4] === 'pending'): ?> bg-yellow-300 text-yellow-900
                                <?php elseif($order[4] === 'preparing'): ?> bg-blue-300 text-blue-900
                                <?php elseif($order[4] === 'ready'): ?> bg-green-300 text-green-900
                                <?php elseif($order[4] === 'completed'): ?> bg-green-300 text-green-900
                                <?php elseif($order[4] === 'cancelled'): ?> bg-red-300 text-red-900
                                <?php endif; ?>
                                    ">
                                    <?php echo e($order[4]); ?>
    ...
    <div class="lg:col-span-2">
        <div class="bg-white rounded-xl shadow-md p-5 sticky top-4 border border-gray-100">
            ...
            <div class="mt-8 pt-6 border-t border-gray-100">
                ...
                <a href="<?php echo e(route('admin.configurations')); ?>" class="flex items-center justify-between p-3 rounded-lg hover:bg-red-50 text-gray-600 hover:text-red-600 transition group">
                    <div class="flex items-center space-x-3">
...
</div><?php /**PATH D:\laragon\www\china-app\resources\views/livewire/Admin/dashboard.blade.php ENDPATH**/ ?>