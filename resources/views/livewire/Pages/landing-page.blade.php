...
>
    {{-- Inline CSS untuk Font & Custom Animations --}}
    <style>
        /* Font Definitions */
        @font-face {
    ...
    {{-- 3. Hero Section - FIXED ANIMATION --}}
        ...
        <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            <div class="space-y-8" style="animation: fadeInUp 1s ease-out;">
                ...
                <h1 class="text-5xl lg:text-7xl font-brand leading-[1.1] text-slate-900 mb-6">
                    ...
                    {{-- Baris 2: Bukan Sekadar Jualan (Gradient) --}}
                ...
                <div class="flex flex-col sm:flex-row gap-4 font-body">
                    <a href="{{ route('register') }}" wire:navigate class="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold text-lg shadow-xl shadow-indigo-600/20 transition-all transform hover:scale-105 text-center">
                        Coba Gratis 14 Hari
                    </a>
    ...
    {{-- 4. Features Grid (Bento Grid Style) --}}
    ...
    {{-- 5. Role Management & Ecosystem Explanation --}}
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="bg-indigo-600 rounded-3xl p-12 text-center text-white relative overflow-hidden mb-20">
                ...
                <div class="relative z-10">
                    <a href="{{ route('register') }}" wire:navigate class="inline-block px-8 py-4 bg-white text-indigo-700 rounded-xl font-bold text-lg shadow-xl hover:bg-indigo-50 transition-colors">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-slate-100 text-slate-500 font-body text-sm">
                <p>&copy; {{ date('Y') }} UKITA Technology. All rights reserved.</p>
