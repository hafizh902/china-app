        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <div class="md:col-span-4">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="https://wa.me/{{ \App\Models\SystemConfig::get('footer_phone')[0]['footer_phone'] ?? '' }}" class="w-8 h-8 rounded-full bg-stone-800 flex items-center justify-center hover:bg-red-700 transition-all text-white text-xs border border-stone-700">
                        <i class="fab fa-whatsapp"></i>
                    </a>
                </div>
            </div>

            {{-- Bagian 2: Contributors / The Scholars (4 Columns) --}}
