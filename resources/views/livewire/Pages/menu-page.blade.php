    ...
    @if ($menuItems->count() > 0)
        ...
        <div class="flex flex-wrap justify-center gap-x-8 gap-y-12">
            @foreach ($menuItems as $item)
                ...
                <div
                    class="group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-amber-100 flex flex-col h-full w-full sm:w-[calc(50%-2rem)] lg:w-[calc(33.333%-2rem)] xl:w-[calc(25%-2rem)] max-w-[350px] {{ !$item->is_available ? 'grayscale' : '' }}">
                        ...
                        <div class="mt-6 flex items-center justify-between border-t border-gray-50 pt-4">
                            ...
                            @if ($item->is_available)
                                <button
                                    ...
                                    <i class="fas fa-plus text-[9px] bg-amber-400 text-red-900 p-1 rounded-full"></i>
                                </button>
                            @else
                                <span
