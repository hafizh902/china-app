            ...
            <div class="lg:col-span-8 space-y-8">
                ...
                <div class="bg-white rounded-[2rem] shadow-sm border border-amber-100 p-8 relative overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- First Name --}}
                        <div class="space-y-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-stone-400 ml-2">{{ __('language.first_name') }} <span class="text-red-500">*</span></label>
                            <input type="text" wire:model.blur="firstName"
                                class="w-full px-5 py-4 bg-stone-50 border-none rounded-2xl focus:ring-2 focus:ring-red-700 transition-all placeholder:text-stone-300 text-sm font-bold @error('firstName') ring-2 ring-red-500 bg-red-50 @enderror"
                                placeholder="Example: John">
                            @error('firstName')
                                <p class="text-red-500 text-[10px] ml-2 font-bold italic">{{ $message }}</p>
                            @enderror
                        </div>

                        {{-- Last Name --}}
                        <div class="space-y-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-stone-400 ml-2">{{ __('language.last_name') }} <span class="text-red-500">*</span></label>
                            <input type="text" wire:model.blur="lastName"
                                class="w-full px-5 py-4 bg-stone-50 border-none rounded-2xl focus:ring-2 focus:ring-red-700 transition-all placeholder:text-stone-300 text-sm font-bold @error('lastName') ring-2 ring-red-500 bg-red-50 @enderror"
                        ...
                        {{-- Email --}}
                        <div class="space-y-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-stone-400 ml-2">{{ __('language.banquet_email') }} <span class="text-red-500">*</span></label>
                            <input type="email" wire:model.blur="email"
                                class="w-full px-5 py-4 bg-stone-50 border-none rounded-2xl focus:ring-2 focus:ring-red-700 transition-all placeholder:text-stone-300 text-sm font-bold @error('email') ring-2 ring-red-500 bg-red-50 @enderror"
                        ...
                        {{-- Phone --}}
                        <div class="space-y-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-stone-400 ml-2">{{ __('language.phone_number') }} <span class="text-red-500">*</span></label>
                            <div class="flex gap-2">
                                ...
                                <input type="text" wire:model.blur="phone"
                                    class="flex-1 px-5 py-4 bg-stone-50 border-none rounded-2xl focus:ring-2 focus:ring-red-700 transition-all placeholder:text-stone-300 text-sm font-bold @error('phone') ring-2 ring-red-500 bg-red-50 @enderror"
                    ...
                    <div class="mt-6 space-y-4 animate-fade-in-down"
                        {{-- Inject Livewire Entangle untuk Address --}}
                        x-data="mapPicker($wire.entangle('address'))"
                        x-init="initMap(@js($restaurantLat), @js($restaurantLng))">

                        {{-- Search Input Container --}}
                        <div class="relative">
                            <label class="text-[10px] font-black uppercase tracking-widest text-stone-400 ml-2 mb-1 block">
                                {{ __('language.search_location') }} <span class="text-red-500">*</span>
                            </label>
                            ...
                            <div class="relative group">
                                ...
                                {{-- Input Field (Sekarang sinkron dengan Livewire address) --}}
                                <input
                                    type="text"
                                    x-model="search"
                                    @input.debounce.500ms="getSuggestions()"
                                    @keydown.escape="suggestions = []"
                                    class="w-full pl-12 pr-12 py-4 bg-stone-50 border-none rounded-2xl focus:ring-2 focus:ring-red-700 transition-all placeholder:text-stone-300 text-sm font-bold shadow-sm @error('address') ring-2 ring-red-500 bg-red-50 @enderror"
                                    placeholder="{{ __('language.search_placeholder') }} (Cth: Jalan Sudirman No. 10, Jakarta...)">
                            ...
                            @error('address')
                                <p class="text-red-500 text-[10px] ml-2 mt-2 font-bold italic">{{ $message }}</p>
                            @enderror
                            {{-- Validasi jika Lat/Lng tidak terisi meski alamat ada (kasus jarang tapi mungkin) --}}
                            @error('lat')
                            ...
                            return {
                                ...
                                initMap(lat, lng) {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        @if($lat && $lng)
                                            this.updateUserMarker(@js($lat), @js($lng), true, false);
                                        @endif
                                    }, 300);
                                },
                ...
                {{-- Payment Method Card (Tidak Berubah Signifikan) --}}
