        ...
        @foreach ($items as $item)
            <div
                ...
                <div class="flex">
                    ...
                    <td class="px-4 py-3 whitespace-nowrap">
                        <span
                            class="px-2.5 py-1 rounded text-white text-xs font-medium {{ $item->is_available ? 'bg-green-600' : 'bg-gray-500' }}">
                            {{ $item->is_available ? 'Available' : 'Unavailable' }}
                        </span>
                    </td>
    ...
    <flux:modal wire:model.live="showCreateModal" class="max-w-xl">
        <div class="p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <flux:input label="Item Name" wire:model.defer="name" placeholder="e.g., Nasi Goreng Spesial"
                        class="w-full" />
                </div>

                <div>
                    <flux:input label="Description" wire:model.defer="description"
                        placeholder="e.g., Makanan ini enak sekali tau" class="w-full" />
                </div>
        ...
        <div class="p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        <flux:input type="number" label="Price (Rp)" wire:model.defer="price"
                            placeholder="25000" />
                    </div>
                </div>

                <div class="bg-gray-50 p-3 rounded border border-gray-200">
                    <flux:checkbox label="Available for order" wire:model.defer="is_available"
