    ...
    <div class="flex justify-between items-end mb-8 sticky top-0 z-40 bg-stone-50 pb-4">
        ...
        <div class="flex gap-3">
            <button wire:click="toggleDeleteMode"
                ...
                {{ $deleteMode ? 'Batal Hapus' : 'Mode Hapus' }}
            </button>
        ...
        <div class="col-span-12 lg:col-span-9">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div wire:key="menu-{{ $item->id }}"
                    ...
                    {{-- Overlay Delete Mode --}}
                    @if ($deleteMode)
                        <div class="absolute inset-0 bg-red-900/10 z-30 cursor-pointer flex items-start p-4" wire:click="toggleSelection({{ $item->id }})">
                ...
                @if ($deleteMode && count($selectedItems) > 0)
                    <div class="mt-6 pt-6 border-t border-stone-100">
                        <button wire:click="deleteSelected"
                            ...
                            Hapus {{ count($selectedItems) }} Menu Terpilih
                        </button>
            ...
            <div class="grid grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        @error('name') <span class="text-red-600 text-[10px] font-bold mt-1 ml-1">{{ $message }}</span> @enderror
                    </div>
