<div class="p-8 bg-stone-50 min-h-screen">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div class="flex items-center gap-2 bg-white px-4 py-2 rounded-2xl shadow-sm border border-stone-200">
            ...
            <span class="text-xs font-bold text-stone-700 uppercase tracking-tighter">{{ $orders->total() }} Orders
                Total</span>
        </div>
    </div>
                    ...
                    <tr class="hover:bg-red-50/30 transition-colors group">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex flex-col">
                                <span
                                    class="text-sm font-bold text-stone-800">{{ $order->user->name ?? 'Guest' }}</span>
                                <span class="text-[10px] text-stone-400 font-medium">{{ $order->items->count() }} Menu
                                    Dipesan</span>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            @endphp
                            <span
                                class="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter {{ $statusClasses[$order->status] ?? 'bg-gray-100' }}">
                                {{ $order->status }}
                            </span>
                        </td>
                ...
                <div class="p-8 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-8 pb-6 border-b border-stone-100">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-sm font-bold text-red-700 uppercase tracking-tighter">
                                {{ ucfirst($selectedOrder->order_type) }}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-stone-50 rounded-2xl p-6 space-y-3">
                        ...
                        <div
                            ...
                            <span>TOTAL</span>
                            <span
                                class="text-red-700 italic">Rp{{ number_format($selectedOrder->total, 0, ',', '.') }}</span>
                        </div>
                    </div>
