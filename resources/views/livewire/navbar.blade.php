    ...
    <nav class="bg-white shadow-lg sticky top-0 z-50 border-b border-gray-100">
                            ...
                            <button @click="open = !open"
                                ...
                                <div class="hidden sm:block text-left">
                                    ...
                                    <div class="text-xs text-gray-500">
                                        {{ auth()->user()->role === 'admin' ? 'Administrator' : 'Customer' }}</div>
                                </div>
                                <!-- Dropdown Icon -->
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                <div class="px-4 py-3 border-b border-gray-100">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <div class="text-sm font-semibold text-gray-800">{{ auth()->user()->name }}
                                            </div>
        ...
        <div class="lg:hidden border-t border-gray-100 bg-gray-50 px-4 py-3">
            <div class="flex justify-around">
                <a href="{{ route('home') }}"
                    class="flex flex-col items-center text-gray-600 hover:text-red-600 transition-colors {{ request()->routeIs('home') ? 'text-red-600' : '' }}">
                    <i class="fas fa-home text-lg mb-1"></i>
                    <span class="text-xs">Home</span>
                </a>
                <a href="{{ route('menu') }}"
                    class="flex flex-col items-center text-gray-600 hover:text-red-600 transition-colors {{ request()->routeIs('menu') ? 'text-red-600' : '' }}">
                    <i class="fas fa-utensils text-lg mb-1"></i>
                    <span class="text-xs">Menu</span>
                </a>
                <a href="{{ route('orders') }}"
                    class="flex flex-col items-center text-gray-600 hover:text-red-600 transition-colors {{ request()->routeIs('orders') ? 'text-red-600' : '' }}">
